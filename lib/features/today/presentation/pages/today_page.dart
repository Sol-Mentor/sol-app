...
class _TodayPageState extends State<TodayPage> {
  ...
  int get _doneCount => _habits.where((_TodayHabit h) => h.isDone).length;

  void _toggleHabit(int index) {
    setState(() {
      final _TodayHabit habit = _habits[index];
      _habits[index] = habit.copyWith(isDone: !habit.isDone);
    });
  ...
  Future<void> _openHabit(int index) async {
    ...
    if (habit.opensBreathwork) {
      await Navigator.of(context).push(
        MaterialPageRoute<void>(builder: (_) => const BreathworkPage()),
      );
      return;
    }
    if (habit.isEditable) {
  ...
  Widget build(BuildContext context) {
    return ListView(
      ...
      children: <Widget>[
        ...
        SolGradCard(
          child: Column(
            ...
            children: <Widget>[
              ...
              Text(
                'Ten minutes of morning light can shift your sleep earlier the same night. Your eyes set the clock for the whole day.',
                style: Theme.of(context).textTheme.bodyMedium?.copyWith(
        ...
        ...List<Widget>.generate(_habits.length, (int index) {
          final _TodayHabit habit = _habits[index];
          return Padding(
      ...
      child: InkWell(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            color: habit.isDone ? SolColors.cocoa.withValues(alpha: 0.04) : SolColors.cream,
            borderRadius: BorderRadius.circular(16),
              ...
              Expanded(
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    Text(habit.subtitle, style: Theme.of(context).textTheme.bodySmall),
                  ],
                ),
              ),
              if (habit.opensBreathwork)
                ...
                Container(
                  ...
                  height: 34,
                  decoration: BoxDecoration(
                    color: habit.isDone ? SolColors.green : SolColors.cocoa.withValues(alpha: 0.08),
...
class _TodayHabit {
  ...
  _TodayHabit copyWith({bool? isDone}) {
    return _TodayHabit(
      id: id,
      icon: icon,
      name: name,
